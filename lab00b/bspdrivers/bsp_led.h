...
// 
#define RED_LED_PIN     (*((volatile uint32_t *)(GPIO_PORTF_BASE |(1<<(1+2)))))  // Red LED
#define GREEN_LED_PIN   (*((volatile uint32_t *)(GPIO_PORTF_BASE |(1<<(2+2)))))  // blue LED
#define BLUE_LED_PIN    (*((volatile uint32_t *)(GPIO_PORTF_BASE |(1<<(3+2)))))  // Green LED
