...
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()  Timer3A_Init()
#define portGET_RUN_TIME_COUNTER_VALUE()          TimerValueGet(TIMER3_BASE, TIMER_A)

#define configMAX_PRIORITIES                16
#define configMAX_CO_ROUTINE_PRIORITIES     ( 2 )
#define configQUEUE_REGISTRY_SIZE           10

/* Timer (software timer) support - required by event groups FromISR glue
 * when xEventGroupSetBitsFromISR uses the timer service to defer work. */
#define configUSE_TIMERS                    1
#define configTIMER_TASK_PRIORITY           ( configMAX_PRIORITIES - 1 )
#define configTIMER_QUEUE_LENGTH            10
/* Stack depth (in words) for the timer service/daemon task. Use the
 * minimal stack size as a reasonable default; adjust if timer callbacks
 * need more stack. */
